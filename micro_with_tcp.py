...
first_run = 1
hold_vpot = 1 
# This is a flag to ensure that when the first run signal is changed, we can still access it later in the code on the first run again
...
name = "cell"
client = Tcp_client(host='192.168.90.163', port=9998, client_name=name)
connect_to_wifi()
client.connect()
    ...
    while True:
        ...
        if timer_elapsed == 1: # This is executed at 1kHz
            ...
            if 1 <= hold_vpot <= 7500: # Run for 5 seconds to ensure closed loop stability
                ...
                # Now, the above value will obviously not work... So let's fix this.
            ...
            if count > 100:
                ...
                print("hold_vpot = {:d}".format(hold_vpot))
